 ...
 *  the number and reveal the original number. In this solution, I apply 
 *  XOR operation to both the index and value of the array. In a complete 
 *  array with no missing numbers, the index and value should be perfectly 
